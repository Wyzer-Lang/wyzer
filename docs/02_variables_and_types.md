...
```wyzer
fn main() {
    let byte_max: u8  = 0xFFu8;
    let nibble:   u8  = 0b1010;
    let port:     u32 = 0x1F90u32;
...
```wyzer
fn main() {
    let mask:    u32 = 0xFF00u32 & 0x0FFFu32;
    let merged:  u32 = 0xFF00u32 | 0x00FFu32;
    let shifted: u32 = 0b0001 << 4;
}
```
